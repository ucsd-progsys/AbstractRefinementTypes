...
with the appropriate set of logical qualifiers $\mathbb{Q}^\star$.
Thereby the above verification can be made automatically,
given that @ v %  2 = 0@ $ \in \mathbb{Q}^\star$.
...
%
This 
approach is extremely heavyweight, requiring us to introduce 
subtyping and all its attendant 
complications into our type system, 
and can make type 
checking undecidable \cite{piercebook}.
